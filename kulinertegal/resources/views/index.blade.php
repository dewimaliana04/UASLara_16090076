...
<head>
    ...
    <title>Tegal Restaurant Modern &mdash; Food Specialty </title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="main-wrapper">
                  ...
                  <div class="carousel-inner">
                    <div class="container">
                      <div class="carousel-caption fadeInUp animated" style="bottom:0;top:200px">
                        <h2 class="display-1" style="color:#fff;">Tegal Restaurant Modern</h2>
                        <p class="h2" style="color: #ddd;padding-top:20px;padding-bottom: 20px">By Dewi Maliana</p>
                      </div>
                    </div>
        ...
        <div id="about">
            <div class="row" style="background-image:url({{ asset('resto/images/wood_1.png')}});">
              ...
              <div class="col-md-6" style="padding:30px 50px;">
                ...
                <p class="lead" style="color:#a99c92;font-weight: 300">Tegal Restaurant Modern, Restoran dengan gaya khas Western yang sangat cocok untuk berbagai acara dan kebutuhan. Dibangun pada tahun 2016, Kami menggunakan bahan - bahan yang berkualitas dan dipilah secara baik dari sumbernya sehingga menghasilkan hasil masakan yang lezat dan berkualitas. Tegal Restaurant Modern menyediakan tempat untuk anda yang ingin berbagi momen bersama orang - orang disekitar anda melalui makanan yang kami sediakan, mari pesan tempat anda sekarang.</p>
              </div>
            </div>
        </div>
                    ...
                    <div class="carousel-item active" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          <h3 class="display-4" style="color:#5e493a;font-size: 40px ;">"Makan adalah hobiku. Tegal Restaurant Modern mengirim hobiku ke tingkatan selanjutnya."</h3>
                          <p class="h4" style="color: gray; padding-top:20px;padding-bottom: 20px">Diasmika</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          ...
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">Isna Amaliya</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          ...
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">Wahyuningsih</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                        <li style="padding-left: 50px;margin-bottom: 10px">
                            ...
                            Jalan Raya Randugunting, <br> Kota Tegal, Jawa Tengah
                        </li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-phone" style="position: absolute;left: 20px"></i> (0361)237-163</li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-envelope" style="position: absolute;left: 20px"></i>dewimaliana2244@gmail.com</li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-globe" style="position: absolute;left: 20px"></i> <a href="#" target="_blank">restaurantmodern.com</a></li>
                    </ul>
                </div>
                <div class="col-md-6">
        ...
        <footer class="footer" style="text-align: center;"> © 2019 All rights reserved. Template designed Dewi Maliana <a href="https://colorlib.com">Colorlib <span id="tes"></span></a></footer>
